defmodule ErpExWeb.ProjectLiveTest do
  ...
  @update_attrs %{name: "some updated name", description: "some updated description", is_active: false}
  @invalid_attrs %{name: nil, description: nil, is_active: false}
